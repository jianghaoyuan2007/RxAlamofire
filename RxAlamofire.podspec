Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/jianghaoyuan2007/RxAlamofire'
  s.authors = { 'Junior B.' => 'info@bonto.ch' }
  s.source = { :git => 'https://github.com/jianghaoyuan2007/RxAlamofire.git', :tag => s.version }
  ...
  s.subspec "Core" do |ss|
    ...
    ss.dependency "RxSwift", "~> 2.6.1"
    ss.dependency "Alamofire", "~> 3.5.1"
    ss.framework  = "Foundation"
  end

  s.subspec "RxCocoa" do |ss|
    ss.source_files = "RxAlamofire/Source/Cocoa/*.swift"
    ss.dependency "RxCocoa", "~> 2.6.1"
